...
// so it survives daemon state saves and restarts.
// - vwap_pullback (S2, Jul 10): v1 retune ran 25 trades at 8% WR / PF 0.36; the v2 rehab
...
// it can progress past forming. Without the partner there is no structural context.
